---
name: planejar-janaina
description: >
  Planeja o calendário mensal de conteúdo da Dra. Janaina.
  ...
  Use: "vamos planejar o mês da Janaina", "montar o calendário da Janaina", /planejar-janaina.
---

# /planejar-janaina — Planejamento Mensal de Conteúdo

## Cliente
**Pasta:** `clientes/dra-janaina-marchi/`
**Conselho:** CFM — Resolução 2336/2023
**Estrutura no Notion:** linhas editoriais

## Dependências
- `clientes/dra-janaina-marchi/CLIENTE.md` — linhas editoriais, mix semanal, tom de voz
- `clientes/dra-janaina-marchi/conhecimento/` — transcrições, lives, entrevistas, referências
...
Ler `clientes/dra-janaina-marchi/CLIENTE.md` e extrair:
- Linhas editoriais com pesos e frequências
- Mix semanal (quantos por semana, por linha)
- Formatos ativos e canais

Ler materiais em `clientes/dra-janaina-marchi/conhecimento/` para calibrar linguagem e repertório da Dra. Janaina.
...
Propor a distribuição de peças respeitando o mix de linhas editoriais da Dra. Janaina:

> "Para a Dra. Janaina em [mês]:
...
- Ler `clientes/dra-janaina-marchi/conhecimento/` antes de escrever
- Tom de voz segue a Dra. Janaina, não a BrainWave
