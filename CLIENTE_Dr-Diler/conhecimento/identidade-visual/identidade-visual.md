# Identidade Visual — Dr. Diler

## Cores

| Nome | Hex |
|------|-----|
| Dourado principal | `#C19B43` |
| Dourado claro | `#EBCA7D` |
| Creme (fundo) | `#FFF7EC` |
| Cinza | `#A6A6A6` |
| Cinza claro | `#D9D9D9` |
| Preto | `#000000` |
...
| Uso | Fontes |
|-----|--------|
| Headlines | Antonio / Bebas Neue Ceryllic / Montserrat Classic |
| Corpo de texto | Montserrat / Montserrat Classic |

## Estilo visual

- Layout **layered**: fundo com desfoque e transparência ~50%, imagem principal com maior contraste, texto em camada intermediária
- **Barra dourada no rodapé** em todas as peças — obrigatório (texto legal)
- Gradiente nos carrosséis para transição entre cards
- Sombra forte sobre texto quando sobreposto a imagem

## Arquivos no Drive

| Arquivo | Link | File ID |
|---------|------|---------|
